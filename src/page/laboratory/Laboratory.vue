<template>
  <div class="list-main">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-tooltip content="修改" placement="top" effect="light">
                <el-button type="info" icon="icon-tsy-xiugai2" circle @click="controlEditDialog(scope.row.id)"></el-button>
              </el-tooltip>
    ...
    <div>
      ...
      <el-dialog title="修改实验室" v-model="editDialogVisible" :visible.sync="editDialogVisible" width="500px"
      :close-on-click-modal="false">
      <template v-if="editDialogVisible">
        <edit-laboratory :close="controlEditDialog" :getList="initData" :id="id"></edit-laboratory>
      </template>
      </el-dialog>
    </div>
  </div>
...
<script>
  ...
  import editLaboratory from '../../model/laboratory/EditLaboratory'
  ...
  export default {
    ...
    methods: {
      ...
      async deleteById(id) {
        ...
        if (isDelete) {
          let result = await laboratoryAPI.removeById({id: id});
